...
class User:
    ...
    def __init__(self, username):
        if username == 'super':
            ...
            self.access_level_id = 0
            self.first_name = 'Super'
            self.last_name = 'User'
            self.location_id = 'BUD001'
            self.department = 'IT'
            self.role = 'God'
            self.locality = 'Budapest'
            self.phone_no = '(123) 456-7890'
            self.email = 'superuser@inv-mgr.com'
            self.address_line1 = '1 Python street'
            self.address_line2 = '99th floor'
            self.region = ''
            self.postcode = '0000'
            self.country = 'HU'
            self.salary_huf = Decimal(1000000)
        else:
